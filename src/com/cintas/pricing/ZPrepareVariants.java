...
public class ZPrepareVariants extends PricingPrepareFormulaAdapter {
	...
	public void addAttributeBindings(IItemUserExitAccess itemUserExitAccess) {
		...
		String[] specialHandlingValues = itemUserExitAccess.getAttributeBinding("SPECIAL HANDLING").getValues();
		String[] packageCodeValues = itemUserExitAccess.getAttributeBinding("PACKAGE CODE").getValues();
